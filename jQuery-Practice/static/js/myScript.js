$(document).ready(function() {
    ...
    $('#large-font-button').on('click', () => {
        $('.colorful-sentence')
        .removeClass('small-font')
        .toggleClass('big-font');
    })

    $('#small-font-button').on('click', () => {
        $('.colorful-sentence')
        .removeClass('big-font')
        .toggleClass('small-font');
    })

    $('.background-colorful-sentence').on('mouseenter', () => {
        $('.background-colorful-sentence').toggleClass('background-color')
    })
  });