...
// varA and varB would only be equal when they are the same data type and have the same value. 
// An unexpected case where 'varA' and 'varB' seem like they are equal but would not pass would be 1 === "1" where one is a number but the other is a string
// Another case with a different data type would be [] === '[]', where an array object does not equal a string
...
function exercise8(amount1, amount2, minimum, maximum) {
  ...
  // Write your code for the exercise below here:
  // --------------------------------------------
  let value1 = (amount1 >= minimum) && amount1 <= maximum;
  let value2 = (amount2 >= minimum) && amount2 <= maximum;
  if (value1 && value2) {
    answer8 = true;
  } else {
    answer8 = false;
...
function exercise10(num10) {
  ...
  if (typeof(num10) === "number") {
    ...
    answer10 = "Please send a number, that was a " + typeof(num10);
  }
  // --------------------------------------------
  // And above here
  // --------------------------------------------
...
// This exercise was fairly easy. However, I was not as familiar with switch so I looked up how to use it here: https://www.w3schools.com/js/js_switch.asp
